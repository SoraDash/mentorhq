...
export async function generateProjectsForStudent(
  course: Course & { projects: ProjectTemplate[] },
  studentId: string,
) {
  // Check if the course is valid
  if (!course) {
    console.log(
      `❌ Cannot generate projects. Invalid course code provided for student ID: ${studentId}`,
    );
