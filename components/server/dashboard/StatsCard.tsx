...
export const StatsCard: React.FC<StatsCardProps> = ({ stats, status, message }) => {
  if (status === 'empty' || message) {
    return <div className="p-4 bg-red-100 text-red-700 border border-red-200 rounded-md">{message}</div>;
  }
