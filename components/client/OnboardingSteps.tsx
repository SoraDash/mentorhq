...
export const OnboardingSteps: React.FC<OnboardingStepsProps> = ({ user, refetchUser }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-10 py-4 bg-white rounded-lg shadow-lg">
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <button className='mt-6 px-6 py-2 bg-green-500 text-white rounded-md shadow-md hover:bg-green-600 inline-flex items-center' onClick={refetchUser}>
          Re-check features
