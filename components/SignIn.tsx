...
export default function SignIn() {
  ...
  return (
    <>
      <Button onPress={onOpen} color='primary' endContent={<FaKey />}>Get Started</Button>
            ...
            <>
              ...
              <ModalBody className='text-center mb-5'>
                ...
                <p className='text-sm max-w-xs mx-auto'>
                  By continuing, you are {isSignUp ? "creating" : "logging into"} a MentorHQ account and agree to our
