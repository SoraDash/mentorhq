...
const MiscForm: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 mt-3 mb-4 space-y-5">
      ...
      <div>
        <label className="block text-gray-700 dark:text-white text-sm font-bold mb-2" htmlFor="ciApiKey">
          CI API Key
        </label>
        <PasswordInput
          id="ciApiKey"
          ...
          className="w-full px-4 py-2 border rounded shadow-sm focus:ring focus:ring-indigo-300 focus:outline-none"
        />
        <label className="block text-gray-700 dark:text-white text-sm font-bold my-5" htmlFor="ciApiKey">
          CI Api Email
